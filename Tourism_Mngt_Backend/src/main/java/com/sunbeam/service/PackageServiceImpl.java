...
//		Package pkg2 = mapper.map(dto, Package.class);
//		Package pkg = packageDao.findById(pkg2.getId()).orElseThrow(()-> new RuntimeException("Package not found"));
//		pkg.setPackageName(pkg2.getPackageName());		
//		pkg.setPackageDetails(pkg2.getPackageDetails());
//		pkg.setStartingPrice(pkg2.getStartingPrice());
//		pkg.setImagePath(pkg2.getImagePath());
